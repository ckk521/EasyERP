...
public class InboundOrderItem {
    ...
    public static final int STATUS_INSPECTED = 2;     // 已验收
    public static final int STATUS_PUTAWAY = 3;       // 已上架
    public static final int STATUS_PARTIAL_RETURN = 4; // 部分退货
    public static final int STATUS_FULL_RETURN = 5;   // 全部退货
}
